...
var MultiFormatUPCEANReader = /** @class */ (function (_super) {
    ...
    function MultiFormatUPCEANReader(hints) {
        ...
        if (possibleFormats != null) {
            ...
            else if (possibleFormats.indexOf(BarcodeFormat_1.default.UPC_A) > -1) {
            ...
            for (var _b = __values(this.readers), _c = _b.next(); !_c.done; _c = _b.next()) {
                ...
                try {
                    ...
                    if (ean13MayBeUPCA && canReturnUPCA) {
                        ...
                        var resultUPCA = new Result_1.default(result.getText().substring(1), rawBytes, rawBytes.length, result.getResultPoints(), BarcodeFormat_1.default.UPC_A);
